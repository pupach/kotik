OBJECTS = $(DIR_O)/use_me_and_live_without_errors.o $(DIR_O)/quad_equ.o $(DIR_O)/debug_and_logs.o $(DIR_O)/main.o $(DIR_O)/comp_double.o $(DIR_O)/input_or_output.o $(DIR_O)/test.o
CC = g++
...
$(DIR_O)/comp_double.o: $(DIR_SOUR)/comp_double.cpp $(DIR_SOUR)/quad_equ.h $(DIR_SOUR)/comp_double.h $(DIR_SOUR)/use_me_and_live_without_errors.h
	$(CC) $(CFLAGS) $< -o $@

$(DIR_O)/input_or_output.o: $(DIR_SOUR)/input_or_output.cpp $(DIR_SOUR)/input_or_output.h $(DIR_SOUR)/quad_equ.h
	$(CC) $(CFLAGS) $< -o $@

$(DIR_O)/debug_and_logs.o: $(DIR_SOUR)/debug_and_logs.cpp $(DIR_SOUR)/debug_and_logs.h $(DIR_SOUR)/use_me_and_live_without_errors.h
	$(CC) $(CFLAGS) $< -o $@

$(DIR_O)/test.o: $(DIR_SOUR)/test.cpp $(DIR_SOUR)/test.h $(DIR_SOUR)/use_me_and_live_without_errors.h $(DIR_SOUR)/quad_equ.h $(DIR_SOUR)/comp_double.h $(DIR_SOUR)/debug_and_logs.h $(DIR_SOUR)/input_or_output.h
	$(CC) $(CFLAGS) $< -o $@
